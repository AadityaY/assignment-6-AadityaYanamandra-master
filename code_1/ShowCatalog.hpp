...
class ShowCatalog{
    private:
        ShowItem* root;
        void deleteNode(ShowItem* node);
        ShowItem* recurSearchbyTitle(ShowItem* node, string title);
        void printNodes(ShowItem* node);
        void leafNodeHelper(ShowItem* node);
        void rootTitleSearch(ShowItem* node, char firstChar);
        void showRatingHelper(ShowItem* node, int& num, std::string rating);
        void insertHelper(ShowItem*& node, std::string title, int year, string showRating, float userRating);
        void preInsertHelper(ShowItem*& node, std::string title, int year, string showRating, float userRating);
